...
def gerar_vetor_dac_parametrizado(frequencia_onda, amostras_por_ciclo, dac_bits, amplitude_normalizada, porcentagem_14, porcentagem_32):
    ...
    dac_valores = [
        int(round(max(0, min(offset + 
                         ...
                         #    amplitude_dac_quinta * math.sin(9 * 2 * math.pi * i / amostras_por_ciclo) +
                             amplitude_dac_14 * math.sin(70 * 2 * math.pi * i / amostras_por_ciclo)+
                             amplitude_dac_32 * math.sin(90 * 2 * math.pi * i / amostras_por_ciclo),
                             max_dac_val))))
...
def salvar_vetor_em_arquivo_c(filename, vetor_dac, freq_onda, num_amostras, res_dac, amp_norm, porc_amplitude_14, porc_amplitude_32, freq_amostragem, prd_timer_val):
...
def senoide():
    ...
    try:
      ...
      #  porc_amplitude_quinta = float(input("Porcentagem da 5ª Harmônica: "))
        ...
        vetor_dac, freq_amostragem = gerar_vetor_dac_parametrizado(freq_onda, num_amostras, res_dac, amplitude_norm, porc_amplitude_14, porc_amplitude_32)
        ...
        salvar_vetor_em_arquivo_c("dac_buffer_values.c", vetor_dac, freq_onda, num_amostras, res_dac, amplitude_norm, porc_amplitude_14, porc_amplitude_32, freq_amostragem, prd_timer)
